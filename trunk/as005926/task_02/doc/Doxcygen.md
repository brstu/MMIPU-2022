...
`class `[`pidController`](#class_p_i_d__controller) | Абстрактный класс пид-контроллера
...
#### Parameters
* `input_temp` Текущая температура 
...
## class `pidController` {#class_p_i_d__controller}
...
`public inline double `[`pidContr`](#class_p_i_d__controller_1a5ac75765c57d0e9d7392e038664922ad)`(double w, double y0, `[`Model`](#class_model)` * model)` | 
...
#### `public inline double `[`pidContr`](#class_p_i_d__controller_1a5ac75765c57d0e9d7392e038664922ad)`(double w, double y0, `[`Model`](#class_model)` * model)` {#class_p_i_d__controller_1a5ac75765c57d0e9d7392e038664922ad}
